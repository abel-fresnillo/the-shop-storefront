...
const otlpAuthHeader = import.meta.env.VITE_OTEL_EXPORTER_OTLP_AUTH_HEADER as string | undefined
const otlpHeaders = otlpAuthHeader ? { Authorization: otlpAuthHeader } : undefined
